...
public interface ImportSignService {
    ...
    Boolean inspectionProcess(String schemaLabel, List<ResponseInvoice> responseInvoiceList, boolean cyYoN, String dzGfTaxno) ;

    Integer getInvoiceDouble(Map<String, String> ocrMap);
