...
public class PermissionAssignController extends AbstractController {
     ...
     */
    @SysLog("角色菜单关联保存")
    @RequestMapping(WebUriMappingConstant.URI_PERMISSION_ASSIGN_ROLE_MENU)
     ...
     */
    @SysLog("角色用户关联保存")
    @RequestMapping(WebUriMappingConstant.URI_PERMISSION_ASSIGN_ROLE_USER_SAVE)
     ...
     */
    @SysLog("获取菜单ID列表")
    @RequestMapping(WebUriMappingConstant.URI_PERMISSION_ASSIGN_QUERY_MENUID_LIST)
     ...
     */
    @SysLog("删除角色用户关联")
    @RequestMapping(WebUriMappingConstant.URI_PERMISSION_ASSIGN_ROLE_USER_DELETE)
