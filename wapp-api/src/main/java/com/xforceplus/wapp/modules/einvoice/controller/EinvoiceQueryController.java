...
import com.xforceplus.wapp.modules.einvoice.WebUriMappingConstant;
...
public class EinvoiceQueryController extends AbstractController {
     ...
     */
    @SysLog("电票查询")
    @RequestMapping(value = WebUriMappingConstant.ELECTRON_INVOICE_QUERY_LIST, method = {POST})
    ...
    @SysLog("电票导出")
    @RequestMapping(value = WebUriMappingConstant.ELECTRON_INVOICE_EXPORT, method = {GET})
