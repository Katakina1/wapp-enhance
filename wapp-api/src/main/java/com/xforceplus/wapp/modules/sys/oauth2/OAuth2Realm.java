...
public class OAuth2Realm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        UserTokenEntity tokenEntity = shiroService.queryByToken(mycatDefaultSchemaLabel, accessToken);
        //token失效
       ...
       // LOGGER.debug("=========================111=======================");
        ...
        //查询用户信息
        UserEntity user = shiroService.queryUser(mycatDefaultSchemaLabel, tokenEntity.getUserId());
        ...
        shiroService.updateToken(user.getSchemaLabel(), tokenEntity);
