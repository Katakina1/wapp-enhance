...
public interface ManualCertificationDao {
     ...
     * @return  Integer
     */
    Integer manualCertification(@Param("schemaLabel") String schemaLabel, @Param("id")String id,@Param("loginName")String loginName,@Param("userName")String userName,@Param("rzhBelongDate")String rzhBelongDate);
