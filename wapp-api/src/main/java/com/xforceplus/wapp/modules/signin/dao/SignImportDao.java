...
public interface SignImportDao {
    ...
    List<String> getOrgCode(@Param("gfTaxNo") String gfTaxNo,@Param("billtypeCode") String billtypeCode);
    ...
    List<RecordInvoiceDataEntity> getRecordDataByDetailYesornoAndSourceSystem();

    void saveDeductibleTax(@Param("schemaLabel") String schemaLabel, @Param("item")RecordInvoiceDataEntity dataEntity);

    String getVenderIdByCostNo(@Param("schemaLabel") String schemaLabel, @Param("costNo")String costNo);

    String getCostNoBySettlement(@Param("schemaLabel") String schemaLabel, @Param("barCode")String barCode);

    Integer getInvoiceDouble(@Param("schemaLabel") String schemaLabel, @Param("item")Map<String, String> ocrMap);
    String getCostNo(@Param("invCode")String invCode,@Param("invNo")String invNo);
    String getSpVenderId(@Param("invCode")String invCode,@Param("invNo")String invNo);
    String getCoseVenderId(@Param("invCode")String invCode,@Param("invNo")String invNo);
    String getOrgVenderId(@Param("xfTaxNo")String xfTaxNo);
    void updateCostScanDate(@Param("costNo")String costNo);
    void updateEpsCostScanDate(@Param("costNo")String costNo);
    void updateAllCostScanDate();

    Integer signInMarkQuery( @Param("invoiceCode") String invoiceCode, @Param("invoiceNo") String invoiceNo);

    Integer getAribaTaxCount(@Param("gf") String gf);

    List<String> getTaxName(@Param("gf") String gf);
