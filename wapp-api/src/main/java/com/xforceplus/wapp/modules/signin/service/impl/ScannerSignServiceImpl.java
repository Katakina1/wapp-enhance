...
//			this.invoiceScanService.delImg(invoiceVo.getScanId());//删除入库失败的发票
    ...
    public static  String getFplx(String fpdm){
        ...
        if (fpdm.trim().length()==12){
            ...
            if (fpdm.substring(0,1).equals("0") && (fpdm.substring(10,12).equals("06") || fpdm.substring(10,12).equals("07"))) {  //判断是否为卷式发票  第1位为0且第11-12位为06或07
                fplx="11";
            }
     ...
     * @return 整理好的商品明细信息
     */
    private List<com.xforceplus.wapp.modules.einvoice.entity.RecordInvoiceDetail> getInvoiceDetails(List<InvoiceDetail> list, String uuid, String invoiceCode, String invoiceNo) {
        List<com.xforceplus.wapp.modules.einvoice.entity.RecordInvoiceDetail> details = Lists.newArrayList();
        com.xforceplus.wapp.modules.einvoice.entity.RecordInvoiceDetail invoiceDetail;
    ...
    public InvoiceScanResultVo insertFromScan(List<SignedInvoiceVo> signedInvoiceVos , Long id){
        ...
        List<RecordInvoice> recordInvoiceList=new ArrayList<>();
        //查验
                ...
                if(null==signedInvoiceVo.getNotes()) {
                    //判断重复扫描
                        ...
                        if (fplx.equals("04")) {
                            ...
                            RecordInvoice recordInvoice = getRRecordInvoiceFromResponse(responseInvoice);
