...
public interface AdvanceDao {
    ...
    void insertUser(@Param("winId")String winId);

    int selectUserId(@Param("winId")String winId);

    void insertRole(@Param("userId")int userId);

    int findByUser(@Param("winId")String winId);

    void updateVenderId(@Param("venderId")String VenderId,@Param("uuid")String uuid);
}