 ...
 */
public class RecordInvoices extends BasePojo {
	...
	public Integer getRzhBelongDate() {
		return rzhBelongDate;
	}

	public void setRzhBelongDate(Integer rzhBelongDate) {
