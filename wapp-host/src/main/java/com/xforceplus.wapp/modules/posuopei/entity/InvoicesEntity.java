...
public class InvoicesEntity extends AbstractBaseDomain {

    private static final long serialVersionUID = 2360986798209603972L;
    //结算单号
    private String bnNo;
    private Long id;//
    ...
    private Long matchno;//发票与结算单匹配关联号
    private String matchStatus;//发票与结算单匹配状态（0-自动  1-手工  2-强制  3-不通过  4-不需匹配  5-取消 6-等待审批 7-拒绝匹配  99-初始
    private String matchDate;//发票与结算单匹配时间
    private String matchUser; //发票与结算单匹配操作员
    private String matchErrInfo;//发票与结算单匹配错误信息
    private String vendorId;//供应商ID
    private Double matchCost;//匹配发票金额（不含税）
    private Double matchVat;//匹配发票税额
    private String matchSerializeId;//匹配通知单号
    ...
    public Date getInvoiceDate() {
        return DateUtils.obtainValidDate(this.invoiceDate);
    }

    public void setInvoiceDate(Date invoiceDate) {
        this.invoiceDate = DateUtils.obtainValidDate(invoiceDate);
    }

    public Date getStatusUpdateDate() {
        return DateUtils.obtainValidDate(this.statusUpdateDate);
    }

    public void setStatusUpdateDate(Date statusUpdateDate) {
        this.statusUpdateDate = DateUtils.obtainValidDate(statusUpdateDate);
    }

    public Date getLastUpdateDate() {
        return DateUtils.obtainValidDate(this.lastUpdateDate);
    }

    public void setLastUpdateDate(Date lastUpdateDate) {
        this.lastUpdateDate = DateUtils.obtainValidDate(lastUpdateDate);
    }

    public Date getRzhDate() {
        return DateUtils.obtainValidDate(this.rzhDate);
    }

    public void setRzhDate(Date rzhDate) {
        this.rzhDate = DateUtils.obtainValidDate(rzhDate);
    }

    public Date getQsDate() {
        return DateUtils.obtainValidDate(this.qsDate);
    }

    public void setQsDate(Date qsDate) {
        this.qsDate =  DateUtils.obtainValidDate(qsDate);
    }

    public Date getConfirmDate() {
        return DateUtils.obtainValidDate(this.confirmDate);
    }

    public void setConfirmDate(Date confirmDate) {
        this.confirmDate = DateUtils.obtainValidDate(confirmDate);
    }
    ...
    public Date getSendDate() {
        return DateUtils.obtainValidDate(this.sendDate);
    }

    public void setSendDate(Date sendDate) {
        this.sendDate = DateUtils.obtainValidDate(sendDate);
    }

    public Date getOutDate() {
        return DateUtils.obtainValidDate(this.outDate);
    }

    public void setOutDate(Date outDate) {
        this.outDate =  DateUtils.obtainValidDate(this.outDate);
    }

    public Date getGxDate() {

        return DateUtils.obtainValidDate(this.gxDate);
    }

    public void setGxDate(Date gxDate) {
        this.gxDate = DateUtils.obtainValidDate(this.gxDate);
    }
