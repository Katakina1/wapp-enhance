...
public class ImportSignHttpQueryController extends AbstractController {
    ...
    @Autowired
    public ImportSignHttpQueryController(ImportSignService importSignService,SignatureProcessingService signatureProcessingService) {
    ...
    public String invoiceQueryHttp(String userId, String token,String ocrMapJson) {
        ...
        if (INVOICE_TYPE.contains(CommonUtil.getFplx(valueOf(ocrMap.get("invoiceCode"))))) {
        	// 普票
