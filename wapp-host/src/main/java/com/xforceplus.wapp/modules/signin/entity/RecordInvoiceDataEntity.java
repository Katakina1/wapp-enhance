...
@Setter
@ToString
public class RecordInvoiceDataEntity extends AbstractBaseDomain {

    private static final long serialVersionUID = 256291694312399451L;
	...
	private String dkInvoiceAmount;

    public String getDkInvoiceAmount() {
        return dkInvoiceAmount;
    }

    public void setDkInvoiceAmount(String dkInvoiceAmount) {
