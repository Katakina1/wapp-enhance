...
<div id="div-export" width="1300px">
    <div align="center"><span class="bold bigSize" style="font-weight:bold;font-size:28px">退 货 协 议</span> </div>
...
<br/>
    ...
    <div  style="float:left;width:90%;">
        ...
        <p>甲方于<span style="text-decoration:underline">${invoiceEntity.pdfDateStart?substring(0,4)}</span>年<span style="text-decoration:underline">${invoiceEntity.pdfDateStart?substring(5,7)}</span>月<span style="text-decoration:underline">${invoiceEntity.pdfDateStart?substring(8,10)}</span>日至<span style="text-decoration:underline">${invoiceEntity.pdfDateEnd?substring(0,4)}</span>年<span style="text-decoration:underline">${invoiceEntity.pdfDateEnd?substring(5,7)}月${invoiceEntity.pdfDateEnd?substring(8,10)}</span>日将上述已购入的部分商品作退货处理：</p>


        <table border="1" style="text-align: center" width="90%" class="table1">
            <tr>
                <td class="bold"  rowspan="3"><div  >产品名称</div></td>
                <td class="bold"  rowspan="3"><div >商品号</div></td>
                <td class="bold"  rowspan="3"><div >单位</div></td>
                <td class="bold"  rowspan="3"><div >规格型号</div></td>
                <td class="bold" colspan="5"><div > 购进商品</div></td>
                <td class="bold" colspan="4"><div>退出商品</div></td>

            </tr>
            <tr>
                <td class="bold"  rowspan="2"><div  >数量</div></td>
                <td class="bold"  rowspan="2"><div >单价</div></td>
         ...
         <#list resultList as item>
            <tr>
                ...
                <td style="text-align: right"><div >${(item.redRushNumber)!}</div></td>
                <td style="text-align: right"><div >${(item.redRushPrice)!}</div></td>
            ...
            <tr>
                ...
                <td style="text-align: left"><div >${(totalData.totalCount)!}</div></td>
                <td style="text-align: left"><div ></div></td>
                <td style="text-align: right"><div >${(totalData.totalAmount)!}</div></td>
                <td style="text-align: right"><div >${(totalData.totalTax)!}</div></td>

                <td style="text-align: right"><div ></div></td>
                <td style="text-align: right"><div >${(totalData.redPushTotalCount)}</div></td>
                <td style="text-align: right"><div ></div></td>
        ...
        <br/>
        <p>2. 本协议一式三份，自双方盖章之日起生效，甲、乙双方/税务机关各执一份,具有同等法律效力。</p>
