    ...
    methods: {
        ...
        exportExcel: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':57,'condition':JSON.stringify(currentQueryParam)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
        ...
        viewQuestionPaper:function (row) {
            ...
            vm.cgwtdforms.totalAmount=row.totalAmount;
