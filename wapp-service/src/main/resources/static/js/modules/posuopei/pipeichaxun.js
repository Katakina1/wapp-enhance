...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            vm.listLoading = true;
            var flag = false;
            this.$http.post(baseURL + 'modules/posuopei/theMatchQuery/list',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/invoicePoRepertoire/queryExportx'
            //     +'?venderid='+ vm.form.venderid
            //     +'&poCode='+ vm.form.poCode
            //     +'&claimNo='+ vm.form.claimNo
            //     +'&invoiceNo='+ vm.form.invoiceNo
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':5,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
