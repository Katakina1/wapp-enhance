    ...
    methods: {
        ...
        editSaveData: function () {
            this.$refs["dataEditForm"].validate(function (valid) {
                if (valid) {
                    $("#updateScan").attr("disabled","true").addClass("is-disabled");
                    ...
                    var params = {
                        ...
                        $.ajax({
                            ...
                            success: function (r) {
                                ...
                                $("#updateScan").removeAttr("disabled").removeClass("is-disabled");
                                vm.dialogVisibleEdit = false;
                                vm.$refs["dataEditForm"].resetFields();
                                vm.findAll(1);
                            }
        ...
        findAll: function (currentPage) {
            ...
            currentQueryParam = {
                ...
                macthStatus:this.q.macthStatus,
                jpl:this.q.jpl,
                gl:this.q.gl,
                rzhYesorno:this.q.rzhYesorno
            };
            vm.listLoading=true;
            $.ajax({
        ...
        updateGl: function (){
            ...
            vm.openConfirm(vm, "\n" + "确定要将符合查询条件的发票确认为所选类型？", function () {
                currentQueryParam = {
                    invoiceNo: vm.q.invoiceNo,
                    invoiceDate1: vm.q.invoiceDate1,
                    invoiceDate2: vm.q.invoiceDate2,
                    shName: vm.q.gfName,
                    invoiceType: vm.q.invoiceType,
                    jvCode:vm.q.jvCode,
                    companyCode:vm.q.companyCode,
                    venderid:vm.q.venderid,
                    scanId:vm.q.scanId,
                    qsStatus:vm.q.qsStatus,
                    flowType:vm.q.flowType,
                    macthStatus:vm.q.macthStatus,
                    jpl:vm.q.jpl,
                    gl:vm.q.gl,
                    glx:vm.q.glx
                };
        ...
        invoiceDate2Change: function (val) {
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':1,'condition':JSON.stringify(currentQueryParam)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
