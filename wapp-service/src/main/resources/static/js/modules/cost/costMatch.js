...
var vm = new Vue({
    ...
    mounted: function () {
        ...
        $.ajax({
            url: baseURL + 'cost/match/getOrgtype',
            type: "POST",
            async: false,
            success: function (r) {
                orgtype = r.orgtype;
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'cost/match/list',
                params,
                {
                    'headers': {
                        "token": token
        ...
        detail: function(row){
            ...
            this.$http.post(baseURL + 'cost/match/detail',
                params,
                {
                    'headers': {
                        "token": token
        ...
        selectDetail: function(row){
            ...
            this.$http.post(baseURL + 'cost/match/selectDetail',
                params,
                {
                    'headers': {
                        "token": token
                ...
                for(var a=this.selectDetailTableData.length-1;a>=0;a--){
                    ...
                    data.coverAmount = data.uncoveredAmount;
            ...
            this.$http.post(baseURL + 'cost/application/searchInvoice',
                ...
                if(info!=null) {
                    ...
                    if((info.dxhyMatchStatus==null || info.dxhyMatchStatus=='0' || info.dxhyMatchStatus=='5' || info.dxhyMatchStatus=='6')
                        && info.totalAmount>info.coveredAmount&&(info.costNo==null || info.costNo=='')) {
        ...
        addCost: function () {
            ...
            for(var i=0;i<this.multipleCostSelection.length;i++){
                ...
                if(this.multipleCostSelection[i].coverAmount > this.multipleCostSelection[i].uncoveredAmount){
                    alert('冲销金额不能大于未冲销金额!');
                    return;
                }
            }
        ...
        submitAll: function () {
            ...
            var settlement = {};
            settlement.venderId = venderInfo.venderId;
        ...
        batchImport: function (event) {
            if (!this.isNeedFileExtension) {
                ...
                var flag = false
                var hh;
                var url = baseURL + "cost/match/excelImport";
