    ...
    methods: {
            ...
            this.$refs[formName].validate(function (valid) {
                if (valid) {
                    currentQueryParam = {
                        ...
                        'returnGoodsStatus': vm.form.returnGoodsStatus
                    };
                    vm.findAll(1);
                } else {
                    return false;
        ...
        findAll: function () {
            var params = {
                ...
                limit: this.pageSize,
                returnGoodsStatus:currentQueryParam.returnGoodsStatus,
                returnGoodsCode:currentQueryParam.returnGoodsCode
            };
            this.listLoading = true;
            var flag = false;
            this.$http.post(baseURL + 'modules/businessData/returngoods/query',
                params,
                {
                    'headers': {
                        "token": token
