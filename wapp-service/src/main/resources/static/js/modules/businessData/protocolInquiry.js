    ...
    methods: {
        ...
        query: function (formName) {
            ...
            this.$refs[formName].validate(function (valid) {
                if (valid) {
                    currentQueryParam = {
                        'agreementCode': vm.form.agreementCode,
                        'agreementStatus': vm.form.agreementStatus
                    };
                    vm.findAll(1);
                } else {
                    return false;
        ...
        findAll:  function (currentPage) {
            var params = {
                ...
                limit: this.pageSize,
                agreementCode:currentQueryParam.agreementCode,
                agreementStatus:currentQueryParam.agreementStatus
            };
            ...
            this.$http.post(baseURL + 'modules/businessData/agreement/query',
                params,
                {
                    'headers': {
                        "token": token
