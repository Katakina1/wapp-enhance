...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function () {
            ...
            var flag = false;
            this.$http.post(baseURL + 'report/supplierIssueInvoiceQuantityandRatio/list',
                params,
                {
                    'headers': {
                        "token": token
...
//                    $("body",parent.document).find("#myiframe").css('height',hh+'px');
        ...
        exportExcel: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':39,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
            ...
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/SupplierIssueInvoiceQuantityandRatioExport'
            //     +'?venderId='+currentQueryParam.venderId
            //     +'&invoiceDate1='+currentQueryParam.invoiceDate1
            //     +'&invoiceDate2='+currentQueryParam.invoiceDate2);
        },
