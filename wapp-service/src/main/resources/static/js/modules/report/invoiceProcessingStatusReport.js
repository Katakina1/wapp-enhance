...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            var flag = false;
            this.$http.post(baseURL + 'report/invoiceProcessingStatusReport/list',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/InvoiceProcessingStatusReportExport'
            //     +'?gfName='+currentQueryParam.gfName
            //     +'&invoiceDate1='+currentQueryParam.invoiceDate1
            //     +'&invoiceDate2='+currentQueryParam.invoiceDate2);
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':47,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
