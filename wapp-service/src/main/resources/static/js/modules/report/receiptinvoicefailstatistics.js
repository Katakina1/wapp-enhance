...
/**
 * Created by joe.tang on 2018/4/18.
 */
...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'report/receiptInvoiceFailStatistics/query',
                postData,
                {
                    'headers': {
                        "token": token
                ...
                if(this.tableData == null || this.tableData.length == 0){
                    $("#btnExport").attr("disabled","disabled").addClass("is-disabled");

                }else{
                    $("#btnExport").removeAttr("disabled").removeClass("is-disabled");
                }
        ...
        querySearchGf: function () {
            $.get(baseURL + 'report/receiptInvoiceFailStatistics/searchGf', function (r) {
                var gfs = [];
                gfs.push({
                    value: "",
                    label: "全部"
        ...
        querySearchXf: function (queryString, callback) {
            $.get(baseURL + 'report/receiptInvoiceFailStatistics/searchXf', {queryString: queryString}, function (r) {
                var resultList = [];
...
//                me.openConfirm(me, "是否确认导出？", function () {
            document.getElementById("ifile").src = baseURL + 'export/receiptInvoiceFailStatistics'
