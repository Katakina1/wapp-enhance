...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'report/signedUncertified/query',
                postData,
                {
                    'headers': {
                        "token": token
        ...
        //     $.get(baseURL + 'report/signedUncertified/searchGf', function (r) {
        //         var gfs = [];
        //         gfs.push({
        //             value: "",
        //             label: "全部"
        ...
        querySearchXf: function (queryString, callback) {
            $.get(baseURL + 'report/signedUncertified/searchXf', {queryString: queryString}, function (r) {
                var resultList = [];
...
//                me.openConfirm(me, "是否确认导出？", function () {
            document.getElementById("ifile").src = baseURL + 'export/signedUncertified'
