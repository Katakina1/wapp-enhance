...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function () {
            ...
            validateDateTypeA(vm.form.invoiceDate1,vm.form.invoiceDate2)
            ...
            var params = {
                ...
                // scanMatchStatus:currentQueryParam.scanMatchStatus,
                invoiceDate1: currentQueryParam.invoiceDate1,
                invoiceDate2: currentQueryParam.invoiceDate2
            };
            this.listLoading = true;
            var flag = false;
            //modules/report/batchSystemMatchQuery/list
            this.$http.post(baseURL + 'modules/report/batchSystemMatchQuery/list',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':3,'condition':JSON.stringify(currentQueryParam)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
            ...
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/InvoiceProcessingStatusReportExports'
            //     +'?gfName='+currentQueryParam.gfName
            //     +'&scanMatchStatus='+currentQueryParam.scanMatchStatus
            //     +'&invNo='+currentQueryParam.invNo
            //     +'&venderId='+currentQueryParam.venderId
            //     +'&batchId='+currentQueryParam.batchId
            //     +'&companyCode='+(currentQueryParam.companyCode==null?'':currentQueryParam.companyCode)
            //     +'&invoiceDate1='+currentQueryParam.invoiceDate1
            //     +'&invoiceDate2='+currentQueryParam.invoiceDate2);
            $("#export_btn").removeAttr("disabled").removeClass("is-disabled");
        },
