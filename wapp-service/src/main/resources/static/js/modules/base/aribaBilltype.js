...
var vm = new Vue({
    ...
    methods: {
        ...
        saveBillTypeData: function () {
            ...
            var url = data.id == null ? "base/aribabilltype/saveBillType" : "base/aribabilltype/updateBillType";
        ...
        deleteOrg: function () {
            ...
            confirm('确定要删除选中的记录？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "base/aribabilltype/deleteBillType",
                    contentType: "application/json",
        ...
        reloadBillType: function () {
            ...
            $.post(baseURL + 'base/aribabilltype/list', data, function (r) {
        ...
        addOrUpdateReset: function () {
            //重置业务类型信息
            this.addOrUpdateForm.serviceName = null;
            this.addOrUpdateForm.mccCode = null;
            this.addOrUpdateForm.glAccount = null;
            this.addOrUpdateForm.serviceType=null;
        },
...
function openAddOrUpdateWin(billtypeid) {
    $.post(baseURL + 'base/aribabilltype/getBillTypeInfoById/' + billtypeid, function (r) {
