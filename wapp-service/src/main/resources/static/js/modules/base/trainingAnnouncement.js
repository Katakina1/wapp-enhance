...
var vm = new Vue({
    ...
    data:{
        ...
        form:{
            ...
            trainDate: new Date().getFullYear()+"-"+format2(new Date().getMonth()+1)+"-"+format2(new Date().getDate())
        },
        announceForm:{
            id:null,
            announcementType:'1',
    ...
    methods: {
        ...
        releaseAnnouncement: function () {
            ...
            formData.append('trainDate',vm.form.trainDate);
            formData.append('announcementType','1');
            var config = {
                headers: {
        ...
        exportData:function(){
            document.getElementById("ifile").src = baseURL + sysUrl.userImportExport;
        },
        /**
         * 格式化日期
         * @param time
