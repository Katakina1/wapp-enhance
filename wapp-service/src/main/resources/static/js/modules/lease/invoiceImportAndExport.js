...
var vm = new Vue({
    ...
    methods: {
        ...
        query: function (formName) {
            ...
            var checkKPDate1 = true;
            var qsStartDate1 = new Date(vm.form.invoiceDate3);
            var qsEndDate1 = new Date(vm.form.invoiceDate4);
            qsStartDate1.setMonth(qsStartDate1.getMonth() + 12);
            ...
            if ( qsEndDate1.getTime()+1000*60*60*24 > qsStartDate1.getTime()) {
                $("#requireMsg5 .el-form-item__content div.el-date-editor:first-child").append('<div class="checkMsg">日期选择跨度不可超过1年</div>');
                checkKPDate1=false;
            }else if(qsEndDate1.getTime() < new Date(vm.form.invoiceDate3)){
        ...
        findAll: function () {
            ...
            var flag = false;
            this.$http.post(baseURL + 'modules/fixed/invoiceImportAndExport/getQuestionnaireList/list',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            document.getElementById("ifile").src = encodeURI(baseURL + 'export/fixed/invoiceImportAndExport/invoiceImportAndExportExports'
                ...
                +'&venderId='+currentQueryParam.venderId
                +'&companyCode='+currentQueryParam.companyCode
                +'&matching='+currentQueryParam.matching
                +'&invoiceDate1='+currentQueryParam.invoiceDate1
                +'&invoiceDate2='+currentQueryParam.invoiceDate2
                +'&invoiceDate3='+currentQueryParam.invoiceDate3
                +'&invoiceDate4='+currentQueryParam.invoiceDate4
            );
        },
