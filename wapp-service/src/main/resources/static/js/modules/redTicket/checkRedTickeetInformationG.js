...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'modules/openRedTicketSupplier/list/queryPaged',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
           ...
           var redNumber =row.redTicketDataSerialNumber;
            ...
            if(buType == 1){
                ...
                this.$http.post(baseURL + 'modules/openRedTicket/return/redTicketDetail',
                    ...
                    vm.currentPage1 = xhr.page1.currPage;;
                    ...
                    this.total3 = xhr.page3.totalCount;
                    this.currentPage3 = xhr.page3.totalPage;
                    this.totalPage3 = xhr.page3.totalPage;
                    this.tableData3 = xhr.page3.list;
            ...
            if(buType == 3){
                ...
                this.$http.post(baseURL + 'modules/RedTicket/discount/redTicketDetail',
                    params,
                    {
                        'headers': {
                            "token": token
        ...
        cancelRedRushInformation:function(row){
            var params = {
                'id': row.id,
                'redticketDataSerialNumber': row.redTicketDataSerialNumber,
                'businessType':row.businessType
            };
            this.$http.post(baseURL + 'modules/cancelRedRushInformation/list/update',
                params,
                {
                    'headers': {
                        "token": token
                ...
                alert(res.body.msg, function () {
                    location.reload();
                });
            });

            /*$.ajax({
                url: baseURL + 'cancelRedRushInformation/list/update',
                type: "POST",
