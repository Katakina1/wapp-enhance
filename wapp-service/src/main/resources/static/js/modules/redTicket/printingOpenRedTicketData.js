...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'modules/openRedTicket/list/queryPrintingPaged',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        printingData: function(row){
            var uri = baseURL + 'export/openRedTicket/openRedDateResultListExport' +'?businessType='+row.businessType +'&redTicketDataSerialNumber='+row.redTicketDataSerialNumber +'&id='+row.id;
            $.ajax({
                type: "POST",
