...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'redInvoiceManager/invoiceList/list',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        storeFormat:function(row, column, cellValue){
        ...
        detail:function(row){
            ...
            $.ajax({
                type: "POST",
                url: baseURL + "transferOut/detailQuery/invoiceDetailList",
                ...
                success: function (r) {
                    if (r.code == 0) {
                        ...
                        vm.detailForm.invoiceDate = vm.formatDate(r.invoiceEntity.invoiceDate);
        ...
        detail1:function(row){
            ...
            this.$http.post(baseURL + 'redInvoiceManager/invoiceList/invoicelist',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':35,'condition':JSON.stringify(currentQueryParam)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
            ...
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/redInvoiceManager/invoiceListExport'
            //     +'?jvCode='+currentQueryParam.jvCode
            //     +'&store='+currentQueryParam.store
            //     +'&redLetterNotice='+currentQueryParam.redLetterNotice
