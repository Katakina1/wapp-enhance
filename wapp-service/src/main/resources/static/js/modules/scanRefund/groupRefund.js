    ...
    methods: {
        ...
        refundyesno:function (row) {
            ...
            confirm('确定要退单吗？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "scanRefund/groupRefund/refundyesno",
        ...
        findAll3: function (currentPage3) {
            ...
            this.$http.post(baseURL + 'scanRefund/groupRefund/claimlist',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        findAll2: function (currentPage2) {
            ...
            this.$http.post(baseURL + 'scanRefund/groupRefund/POlist',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'scanRefund/groupRefund/list',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
