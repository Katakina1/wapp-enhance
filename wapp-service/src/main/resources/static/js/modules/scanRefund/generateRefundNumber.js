    ...
    methods: {
        ...
        refundNumber:function (row) {
            ...
            confirm('确定生成退单号吗？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "scanRefund/GenerateRefundNumber/uplist",
        ...
        exportExcel: function(){
            // document.getElementById("ifile").src = encodeURI(baseURL + 'scanRefund/GenerateRefundNumber/listAll'
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':31,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'scanRefund/GenerateRefundNumber/list',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
