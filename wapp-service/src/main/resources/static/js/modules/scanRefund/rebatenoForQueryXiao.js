...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            var flag = false;
            this.$http.post(baseURL + 'modules/scanRefund/groupRefund/xiaolist',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/scanRefund/rebateForQueryXiaoExport'
            //     +'?jvCode='+vm.form.jvCode
            //     +'&invoiceNo='+vm.form.invoiceNo
            //     +'&rebateDate1='+vm.form.rebateDate1
            //     +'&rebateDate2='+vm.form.rebateDate2
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':6,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
