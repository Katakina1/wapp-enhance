...
var currentQueryParam = {
    ...
    xfName: null,
    invoiceNo: null,
    matchDate1: new Date().getFullYear()+"-"+format2(new Date().getMonth())+"-01",
...
var vm = new Vue({
    ...
    mounted:function(){
        this.matchDateOptions1 = {
            disabledDate: function(time){
                var currentTime = new Date(vm.formatDate(vm.form.matchDate2));
                return time.getTime() >= currentTime;
            }

        };
        this.matchDateOptions2 = {
            disabledDate: function(time){
                var currentTime = new Date(vm.formatDate(vm.form.matchDate1));
    ...
    methods: {
        ...
        refundyesno:function (row) {
            ...
            confirm('确定要退单吗？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "index/indexGroupRefund/refundyesno",
        ...
        query: function (formName) {
            ...
            var qsStartDate = new Date(vm.form.matchDate1);
            var qsEndDate = new Date(vm.form.matchDate2);
            ...
            if ( qsEndDate.getTime()+1000*60*60*24 > qsStartDate.getTime()) {
                ...
                checkKPDate=false;
            }else if(qsEndDate.getTime() < new Date(vm.form.matchDate1)){
        ...
        submitForm:function(row) {
            ...
            var url = "index/indexGroupRefund/refund";
        ...
        matchDate1Change: function(val) {
            vm.form.matchDate1 = val;
        },
        matchDate2Change: function(val) {
            vm.form.matchDate2 = val;
        },
        ...
        findAll2: function (currentPage2) {
            ...
            this.$http.post(baseURL + 'index/indexGroupRefund/POlist',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        findAll1: function (currentPage1) {
            ...
            this.$http.post(baseURL + 'index/indexGroupRefund/recordinvoicelist',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'index/indexGroupRefund/list',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
        ...
        detail1:function(row){
            ...
            this.$http.post(baseURL + 'index/indexGroupRefund/alllist',
                params,
                {
                    'headers': {
                        "token": token
