...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function () {
            ...
            var flag = false;
            this.$http.post(baseURL + 'modules/InformationInquiry/claimlist/query',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':24,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
        ...
        exportExcel2: function(){
            document.getElementById("ifile").src = encodeURI(baseURL + 'export/InformationInquiryClaimDetailExport'
                +'?venderid='+currentQueryParam.venderid
                +'&claimno='+currentQueryParam.claimno
                +'&invoiceDate1='+currentQueryParam.invoiceDate1
                +'&invoiceDate2='+currentQueryParam.invoiceDate2
