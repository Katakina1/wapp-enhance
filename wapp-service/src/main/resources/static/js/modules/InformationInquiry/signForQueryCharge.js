    ...
    methods: {
        ...
        findAll: function (currentPage) {
            var params = {
                ...
                scanNo:vm.form.scanNo

        };
            this.listLoading = true;
            var flag = false;
            this.$http.post(baseURL + 'modules/InformationInquiry/signForQuery/matchQuerys/lists',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/InformationInquiry/signForQuery/signForQueryExports'
            //     +'?jvCode='+vm.form.jvCode
            //     +'&invoiceNo='+vm.form.invoiceNo
            //     +'&invoiceDate1='+vm.form.invoiceDate1
            //     +'&invoiceDate2='+vm.form.invoiceDate2
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':46,'condition':JSON.stringify(params)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
