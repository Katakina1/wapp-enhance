...
var vm = new Vue({
    ...
    methods: {
        ...
        getJVByTaxNo: function(taxNo){
            $.get(baseURL + 'info/costScanConfirm/getJV',{taxNo: taxNo},function(r){
                var gfs = [];
                for(var i=0;i<r.optionList.length;i++){
                    var gf = {};
                    gf.value = r.optionList[i].optionKey;
        ...
        getVender: function(){
            $.get(baseURL + 'info/costScanConfirm/getVender',function(r){
                var gfs = [];
                for(var i=0;i<r.optionList.length;i++){
                    var gf = {};
                    gf.value = r.optionList[i].optionKey;
        ...
        submitConfirm: function(){
            ...
            $.ajax({
                type:"POST",
                url:baseURL + 'info/costScanConfirm/submit',
        ...
        exportExcel: function(){
            ...
            document.getElementById("ifile").src = encodeURI(baseURL + 'export/info/costScanConfirm'
        ...
        importSubmit: function(){
            if (!this.isNeedFileExtension) {
                ...
                var flag = false
                var hh;
                var url = baseURL + "import/info/costScanConfirm";
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'info/costScanConfirm/list',
                currentQueryParam,
                {
                    'headers': {
                        "token": token
