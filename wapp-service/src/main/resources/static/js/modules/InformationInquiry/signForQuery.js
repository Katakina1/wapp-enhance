...
var vm = new Vue({
    ...
    methods: {
        ...
        findAll: function (currentPage) {
            ...
            var flag = false;
            this.$http.post(baseURL + 'modules/InformationInquiry/signForQuery/matchQuerys/list',
                params,
                {
                    'headers': {
                        "token": token
        ...
        exportExcel: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'serviceType':2,'condition':JSON.stringify(currentQueryParam)},
                success:function (r) {
                    flag = true;
                    if(r.code==0){
                        alert(r.data);
            ...
            // document.getElementById("ifile").src = encodeURI(baseURL + 'export/InformationInquiry/signForQuery/signForQueryExport'
            //     +'?jvCode='+vm.form.jvCode
            //     +'&invoiceNo='+vm.form.invoiceNo
            //     +'&invoiceDate1='+vm.form.invoiceDate1
            //     +'&invoiceDate2='+vm.form.invoiceDate2
