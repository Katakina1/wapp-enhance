...
//复选框
        ...
        findAll: function (currentPage) {
            ...
            var params = {
                ...
                billtype:currentQueryParam.billtype
            };
            this.listLoading = true;
            var flag = false;
            this.$http.post(baseURL + 'modules/InformationInquiry/questionnaire/getQuestionnaireList/cplist',
                params,
                {
                    'headers': {
                        "token": token
