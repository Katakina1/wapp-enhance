    ...
    methods: {
        ...
        exportOut:function(){
            document.getElementById("ifile").src = baseURL + 'export/transferOutInvoiceQueryExport'
                +'?gfTaxNo='+(vm.form.gfTaxNo=='-1'?'':vm.form.gfTaxNo)
                +'&xfName='+(vm.form.xfName==null?'':vm.form.xfName)
                +'&invoiceNo='+(vm.form.invoiceNo==null?'':vm.form.invoiceNo)
                +'&invoiceStatus='+(vm.form.invoiceStatus=='-1'?'':vm.form.invoiceStatus)
                +'&outReason='+(vm.form.outReason=='-1'?'':vm.form.outReason)
                +'&outDate1='+vm.form.outDate1
                +'&outDate2='+vm.form.outDate2;
        },
