...
var vm = new Vue({
    ...
    methods: {
        ...
        exportOut: function () {
            document.getElementById("ifile").src = baseURL + 'export/transferOutInvoiceQueryExport'
                + '?gfTaxNo=' + (vm.exportForm.gfTaxNo == '-1' ? '' : vm.exportForm.gfTaxNo)
                + '&xfName=' + (vm.exportForm.xfName == null ? '' : vm.exportForm.xfName)
                + '&invoiceNo=' + (vm.exportForm.invoiceNo == null ? '' : vm.exportForm.invoiceNo)
                + '&invoiceStatus=' + (vm.exportForm.invoiceStatus == '-1' ? '' : vm.exportForm.invoiceStatus)
                + '&outReason=' + (vm.exportForm.outReason == '-1' ? '' : vm.exportForm.outReason)
                + '&outDate1=' + vm.exportForm.outDate1
                + '&outDate2=' + vm.exportForm.outDate2;
        },
        ...
        findAll: function (currentPage) {
            ...
            this.$http.post(baseURL + 'transferOut/transferOutQuery/TransferOutedQuery',
                ...
                if (this.total == 0) {
                    ...
                    vm.exportForm.gfTaxNo = vm.form.gfTaxNo;
                    vm.exportForm.xfName = vm.form.xfName;
                    vm.exportForm.invoiceNo = vm.form.invoiceNo;
                    vm.exportForm.invoiceStatus = vm.form.invoiceStatus;
                    vm.exportForm.outReason = vm.form.outReason;
                    vm.exportForm.outDate1 = vm.form.outDate1;
                    vm.exportForm.outDate2 = vm.form.outDate2;
                }
