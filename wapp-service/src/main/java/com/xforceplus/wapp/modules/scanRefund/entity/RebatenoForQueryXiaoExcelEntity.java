 ...
 * 发票匹配
 */
public class RebatenoForQueryXiaoExcelEntity  extends BaseRowModel {

    @ExcelProperty(value={"发票退票查询报告"},index = 0)
    private String cell0;


    @ExcelProperty(value={"发票退票查询报告"},index = 1)
    private String cell1;

    @ExcelProperty(value={"发票退票查询报告"},index = 2)
    private String cell2;

    @ExcelProperty(value={"发票退票查询报告"},index = 3)
    private String cell3;

    @ExcelProperty(value={"发票退票查询报告"},index = 4)
    private String cell4;

    @ExcelProperty(value={"发票退票查询报告"},index = 5)
    private String cell5;

    @ExcelProperty(value={"发票退票查询报告"},index = 6)
    private String cell6;

    @ExcelProperty(value={"发票退票查询报告"},index = 7)
    private String cell7;

    @ExcelProperty(value={"发票退票查询报告"},index = 8)
    private String cell8;

    @ExcelProperty(value={"发票退票查询报告"},index = 9)
    private String cell9;

    @ExcelProperty(value={"发票退票查询报告"},index = 10)
    private String cell10;

    @ExcelProperty(value={"发票退票查询报告"},index = 11)
    private String cell11;

    @ExcelProperty(value={"发票退票查询报告"},index = 12)
    private String cell12;

    @ExcelProperty(value={"发票退票查询报告"},index = 13)
    private String cell13;

    @ExcelProperty(value={"发票退票查询报告"},index = 14)
    private String cell14;

    @ExcelProperty(value={"发票退票查询报告"},index = 15)
    private String cell15;

    @ExcelProperty(value={"发票退票查询报告"},index = 16)
    private String cell16;

    @ExcelProperty(value={"发票退票查询报告"},index = 17)
    private String cell17;

    @ExcelProperty(value={"发票退票查询报告"},index = 18)
    private String cell18;
    @ExcelProperty(value={"发票退票查询报告"},index = 19)
