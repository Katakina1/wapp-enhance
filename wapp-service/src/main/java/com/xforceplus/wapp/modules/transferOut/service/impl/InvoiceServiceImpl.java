...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    public Map<String, BigDecimal> getSumAmount(String schemaLabel,Query query) {
        return invoiceDao.getSumAmount(schemaLabel,query);
    }

    @Override
    public Map<String, BigDecimal> getOutedSumAmount(String schemaLabel,Query query) {
        return invoiceDao.getOutedSumAmount(schemaLabel,query);
    }
    ...
    @Override
    public InvoiceEntity getCheckDetailInfo(String schemaLabel,Long id) throws Exception{
        InvoiceEntity invoiceEntity=invoiceDao.getCheckDetailInfo(schemaLabel,id);
        invoiceEntity.setStringTotalAmount(RMBUtils.getRMBCapitals(Math.round(invoiceEntity.getTotalAmount()*100)));
        return invoiceEntity;
    }
