...
public class ComprehensiveInvoiceQueryController extends AbstractController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        return R.ok().put("page", pageUtil).put("totalAmount", result.getTotalAmount()).put("totalTax", result.getTotalTax()).put("taxAmount",result.getTaxAmount());
    }
    ...
    public R searchGf() {
      ...
      /* for (GfOptionEntity gfOptionEntity : optionList) {
		System.out.println(gfOptionEntity.getLabel()+","+gfOptionEntity.getOrgCode()+","+gfOptionEntity.getValue());
	}*/
    ...
    public R searchFlowType() {
        List<OptionEntity> optionList = comprehensiveInvoiceQueryService.searchflowType();
        return R.ok().put("optionList", optionList);
    }
}
