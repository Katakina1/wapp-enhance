 ...
 ******************************************************************************
 */
public class InvoiceReturnExportThread extends BaseThread {
	...
	public InvoiceReturnExportThread(IExcelExportService exportLogService,
                                     ExportLogEntity exportLog, InvoiceBorrowService invoiceBorrowService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =invoiceBorrowService.queryInvoiceBorrowList(map).getTotalCount();
					...
					sheet.setClazz(FpghExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<FpghExcelEntity> list2=invoiceBorrowService.transformExcle2(invoiceBorrowService.queryInvoiceBorrowList(query1).getResults());
