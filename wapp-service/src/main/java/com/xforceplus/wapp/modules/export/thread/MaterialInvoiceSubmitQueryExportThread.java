 ...
 ******************************************************************************
 */
public class MaterialInvoiceSubmitQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "MaterialInvoiceSubmitQuery";
	/**
	 * 文件名后缀
	 */
	...
	public MaterialInvoiceSubmitQueryExportThread(IExcelExportService exportLogService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =dataInvoiceSubmitService.queryRealCount(map);
