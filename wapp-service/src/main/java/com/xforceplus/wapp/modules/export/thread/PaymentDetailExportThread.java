 ...
 ******************************************************************************
 */
public class PaymentDetailExportThread extends BaseThread {
	...
	public PaymentDetailExportThread(IExcelExportService exportLogService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					sheet.setClazz(PaymentDetailExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<PaymentDetailExcelEntity> list2 = paymentDetailService.selectFindPayList(query1);
