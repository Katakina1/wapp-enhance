...
public interface NoDetailedInvoiceDao {
     ...
     *  recordInvoiceStatisticsList 抵账统计
     * @return 执行结果
     */
    ...
    Integer insertStatisticsList(RecordInvoiceStatistics recordInvoiceStatistics);
...
//    Integer insertVehicleDetailList(@Param("schemaLabel") String schemaLabel, @Param("list") List<InvoiceCheckVehicleDetailModel> model);
      Integer insertVehicleDetailList(InvoiceCheckVehicleDetailModel invoiceCheckVehicleDetailModel);
    /**
     * 插入前删除明细数据
     * @param schemaLabel
     * @param invoiceDetailInfoList
     */
    void deleteDetail(@Param("schemaLabel") String schemaLabel, @Param("invoiceDetailInfo") InvoiceDetailInfo invoiceDetailInfo);

    Integer selectStatisticsList( RecordInvoiceStatistics recordInvoiceStatistics);

    void updateStatisticsList(RecordInvoiceStatistics recordInvoiceStatistics);

    Integer selectVehicleDetailList(InvoiceCheckVehicleDetailModel invoiceCheckVehicleDetailModel);

    void updateVehicleDetailList(InvoiceCheckVehicleDetailModel invoiceCheckVehicleDetailModel);
}
