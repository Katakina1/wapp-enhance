 ...
 * 发票综合查询
 */
public interface SignForQueryService {
    /**
     * 分页列表
     * @param map
     * @return
     ...
     * @return
     */
    List<SignForQueryEntity> queryListAll(Map<String, Object> map);

    List<SignForQueryExcelEntity> transformExcle(List<SignForQueryEntity> list);
}
