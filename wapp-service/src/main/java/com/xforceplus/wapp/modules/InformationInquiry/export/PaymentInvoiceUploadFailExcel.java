...
public final class PaymentInvoiceUploadFailExcel extends AbstractExportExcel{
    ...
    public PaymentInvoiceUploadFailExcel(Map<String, Object> map, String excelTempPath, String excelName) {
        this.map = map;
    ...
    protected void buildExcel(XSSFWorkbook workBook) {
        ...
        for (PaymentInvoiceUploadEntity entity : list) {
            ...
            //成本金额
            setSheetValue(sheet, beginLine, 8, entity.getReturnCostAmount(), style);
            //供应商结款发票号
            ...
            //税率
            setSheetValue(sheet, beginLine, 12, entity.getTaxRate().toString(), style);
            //含税金额
            ...
            //失败原因
            setSheetValue(sheet, beginLine, 18, entity.getFailReason(), style);
            //上传问题发票时间
            setSheetValue(sheet, beginLine, 19, entity.getUploadDate(), style);
