...
@Service
@Transactional
public class CostQueryQuitServiceImpl implements CostQueryQuitService {
    ...
    public List<SettlementEntity> queryList(Map<String, Object> map) {
        return signininqueryCostQueryDao.queryLists(map);
    }
    ...
    public Integer queryCount(Map<String, Object> map) {
        return signininqueryCostQueryDao.queryCounts(map);
    }
