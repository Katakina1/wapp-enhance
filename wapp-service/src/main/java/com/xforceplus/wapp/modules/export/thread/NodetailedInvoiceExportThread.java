 ...
 ******************************************************************************
 */
public class NodetailedInvoiceExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "NoDetailInvoiceList";
	/**
	 * 文件名后缀
	 */
	...
	public NodetailedInvoiceExportThread(IExcelExportService exportLogService,
                                         ExportLogEntity exportLog, NoDetailedInvoiceService noDetailedInvoiceService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =noDetailedInvoiceService.selectNoDetailedInvoice(map).getTotalCount();
					...
					sheet.setClazz(NoDetailInvoiceExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceCollectionInfo> list = noDetailedInvoiceService.selectNoDetailedInvoice(query1).getResults();
						List<NoDetailInvoiceExcelEntity> list2=noDetailedInvoiceService.toExcel(list);
