 ...
 ******************************************************************************
 */
public class InvoiceQueryExportThread extends BaseThread {
	...
	public InvoiceQueryExportThread(IExcelExportService exportLogService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					sheet.setClazz(InvoiceQueryExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceQueryExcelEntity> list2 = comprehensiveInvoiceQueryService.queryInvoiceExcelListAll("",query1);
