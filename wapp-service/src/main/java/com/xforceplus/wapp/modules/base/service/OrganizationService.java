...
public interface OrganizationService {
    ...
    void saveOrgMenu(String schemaLabel, String namestr, Integer orgid);

    Integer getOrgCodeCount(String schemaLabel,String orgcode);
    /**
     * 导入公司代码
     * @param multipartFile
     * @param logingName
     ...
     * @return
     */
    Map<String, Object> parseJvAndStoreExcel(MultipartFile multipartFile, String logingName);
