 ...
 ******************************************************************************
 */
public class InvoiceProcessingStatusReportExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "invoiceProcessingStatusReport";
	/**
	 * 文件名后缀
	 */
	...
	public InvoiceProcessingStatusReportExportThread(IExcelExportService exportLogService,
                                                     ExportLogEntity exportLog, InvoiceProcessingStatusReportService invoiceProcessingStatusReportService,
                                                     FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.invoiceProcessingStatusReportService = invoiceProcessingStatusReportService;
	...
	public void run() {
		...
		try {
			...
			try {
				...
				Integer totalRowCount = invoiceProcessingStatusReportService.matchlistCount( map);
				...
				sheet.setClazz(MatchExcelEntity.class);
				...
				for (int i = 0; i < writeCount; i++) {
					...
					List<MatchEntity> InvoiceEntityList = invoiceProcessingStatusReportService.matchlist( query1);
					List<MatchExcelEntity> list2 = invoiceProcessingStatusReportService.transformExcle(InvoiceEntityList);
