...
@Getter
@Setter
public class SpthpExcelEntity extends BaseRowModel implements Serializable {




    @ExcelProperty(value={"扫描人工确认"},index = 0)
    private String cell0;

    @ExcelProperty(value={"扫描人工确认"},index = 1)
    private String cell1;

    @ExcelProperty(value={"扫描人工确认"},index = 2)
    private String cell2;

    @ExcelProperty(value={"扫描人工确认"},index = 3)
    private String cell3;

    @ExcelProperty(value={"扫描人工确认"},index = 4)
    private String cell4;

    @ExcelProperty(value={"扫描人工确认"},index = 5)
    private String cell5;

    @ExcelProperty(value={"扫描人工确认"},index = 6)
    ...
    @ExcelProperty(value={"扫描人工确认"},index = 7)
    private String cell7;

    @ExcelProperty(value={"扫描人工确认"},index = 8)
    private String cell8;



    @ExcelProperty(value={"扫描人工确认"},index = 9)
    private String cell9;

    @ExcelProperty(value={"扫描人工确认"},index = 10)
    private String cell10;

    @ExcelProperty(value={"扫描人工确认"},index = 11)
    private String cell11;

    @ExcelProperty(value={"扫描人工确认"},index = 12)
    private String cell12;

    @ExcelProperty(value={"扫描人工确认"},index = 13)
    private String cell13;

    @ExcelProperty(value={"扫描人工确认"},index = 14)
    private String cell14;

    @ExcelProperty(value={"扫描人工确认"},index = 15)
