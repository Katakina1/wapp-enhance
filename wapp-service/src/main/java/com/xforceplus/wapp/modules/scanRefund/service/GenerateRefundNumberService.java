 ...
 * 发票综合查询
 */
public interface GenerateRefundNumberService {
    /**
     * 分页列表
     * @param map
     * @return
    ...
    List<SctdhExcelEntity> transformExcle(List<GenerateRefundNumberEntity> generateRefundNumber) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException;
}
