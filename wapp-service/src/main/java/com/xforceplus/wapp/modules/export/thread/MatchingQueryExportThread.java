 ...
 ******************************************************************************
 */
public class MatchingQueryExportThread extends BaseThread {
	...
	public MatchingQueryExportThread(IExcelExportService exportLogService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =detailsService.invoiceMatchCount(map);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<MatchEntity> InvoiceEntityList = detailsService.queryList(query1);
