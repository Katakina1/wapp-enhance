...
import com.xforceplus.wapp.modules.redTicket.entity.OpenRedExcelEntity;
 ...
 ******************************************************************************
 */
public class OpenRedExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "OpenRedQueryList";
	/**
	 * 文件名后缀
	 */
	...
	public OpenRedExportThread(IExcelExportService exportLogService,
                               ExportLogEntity exportLog, QueryOpenRedTicketDataService queryOpenRedTicketDataService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =queryOpenRedTicketDataService.getRedTicketMatchListCount(map);
					...
					sheet.setClazz(OpenRedExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<RedTicketMatch> list = queryOpenRedTicketDataService.queryOpenRedTicket(query1);
						List<OpenRedExcelEntity> list2=queryOpenRedTicketDataService.toExcel(list);
