...
@Getter
@Setter
public class SctdhExcelEntity extends BaseRowModel implements Serializable {




    @ExcelProperty(value={"生成退单号"},index = 0)
    private String cell0;

    @ExcelProperty(value={"生成退单号"},index = 1)
    private String cell1;

    @ExcelProperty(value={"生成退单号"},index = 2)
    private String cell2;

    @ExcelProperty(value={"生成退单号"},index = 3)
    private String cell3;

    @ExcelProperty(value={"生成退单号"},index = 4)
    private String cell4;

    @ExcelProperty(value={"生成退单号"},index = 5)
    private String cell5;

    @ExcelProperty(value={"生成退单号"},index = 6)
    ...
    @ExcelProperty(value={"生成退单号"},index = 7)
    private String cell7;

    @ExcelProperty(value={"生成退单号"},index = 8)
    private String cell8;



    @ExcelProperty(value={"生成退单号"},index = 9)
    private String cell9;

    @ExcelProperty(value={"生成退单号"},index = 10)
