...
@Getter
@Setter
public class FpjyExcelEntity   extends BaseRowModel implements Serializable {




    @ExcelProperty(value={"发票借阅"},index = 0)
    private String cell0;

    @ExcelProperty(value={"发票借阅"},index = 1)
    private String cell1;

    @ExcelProperty(value={"发票借阅"},index = 2)
    private String cell2;

    @ExcelProperty(value={"发票借阅"},index = 3)
    private String cell3;

    @ExcelProperty(value={"发票借阅"},index = 4)
    private String cell4;

    @ExcelProperty(value={"发票借阅"},index = 5)
    private String cell5;

    @ExcelProperty(value={"发票借阅"},index = 6)
    ...
    @ExcelProperty(value={"发票借阅"},index = 7)
    private String cell7;

    @ExcelProperty(value={"发票借阅"},index = 8)
    private String cell8;



    @ExcelProperty(value={"发票借阅"},index = 9)
    private String cell9;

    @ExcelProperty(value={"发票借阅"},index = 10)
    private String cell10;

    @ExcelProperty(value={"发票借阅"},index = 11)
    private String cell11;

    @ExcelProperty(value={"发票借阅"},index = 12)
    private String cell12;

    @ExcelProperty(value={"发票借阅"},index = 13)
    private String cell13;

    @ExcelProperty(value={"发票借阅"},index = 14)
    private String cell14;

    @ExcelProperty(value={"发票借阅"},index = 15)
    private String cell15;

    @ExcelProperty(value={"发票借阅"},index = 16)
    private String cell16;

    @ExcelProperty(value={"发票借阅"},index = 17)
    private String cell17;
    @ExcelProperty(value={"发票借阅"},index = 18)
    private String cell18;
    @ExcelProperty(value={"发票借阅"},index = 19)
    private String cell19;
    @ExcelProperty(value={"发票借阅"},index = 20)
    private String cell20;
    @ExcelProperty(value={"发票借阅"},index = 21)
    private String cell21;
    @ExcelProperty(value={"发票借阅"},index = 22)
