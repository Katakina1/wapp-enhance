 ...
 ******************************************************************************
 */
public class AuthenticationQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "AuthenticationQuery";
	/**
	 * 文件名后缀
	 */
	...
	public AuthenticationQueryExportThread(IExcelExportService exportLogService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =authenticationQueryService.getCertificationListCount(map).getTotalCount();
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceCollectionTaxExcelInfo> list = authenticationQueryService.queryCertificationForExcel(query1);
