 ...
 */
@RestController
@RequestMapping("/scanRefund/printRefundInformationCost")
public class PrintRefundInformationCostController extends AbstractController {

    private static final Logger LOGGER = LoggerFactory.getLogger(PrintRefundInformationController.class);

    @Autowired
    private CostPrintRefundInformationService printRefundInformationService;
