...
public interface InvoiceDao extends BaseDao<InvoiceEntity>{
     ...
     * @return 金额之和，税额之和
     */
    Map<String, BigDecimal> getSumAmount(@Param("schemaLabel") String schemaLabel, @Param("map")Map<String, Object> map);

    /**
     * 获取已转出进项税所有金额之和，所有税额之和
     * @param map 参数
     * @return 金额之和，税额之和
     */
    Map<String, BigDecimal> getOutedSumAmount(@Param("schemaLabel") String schemaLabel, @Param("map")Map<String, Object> map);
    ...
    InvoiceEntity getCheckDetailInfo(@Param("schemaLabel") String schemaLabel,@Param("id")Long id);
