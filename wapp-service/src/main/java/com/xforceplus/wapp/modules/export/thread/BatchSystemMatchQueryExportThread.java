 ...
 ******************************************************************************
 */
public class BatchSystemMatchQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "batchSystemMatchQueryList";
	/**
	 * 文件名后缀
	 */
	 ...
	 * excel的标题
	 */
	private String title = "HOST匹配成功报告";
	...
	public BatchSystemMatchQueryExportThread(IExcelExportService exportLogService,
                                             ExportLogEntity exportLog, BatchSystemMatchQueryService batchSystemMatchQueryService,
                                             FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.batchSystemMatchQueryService = batchSystemMatchQueryService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =batchSystemMatchQueryService.matchlistCounts(map);
					...
					sheet.setClazz(BatchSystemMatchQueryExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<BatchSystemMatchQueryEntity> InvoiceEntityList = batchSystemMatchQueryService.matchlists(query1);
						List<BatchSystemMatchQueryExcelEntity> list2=batchSystemMatchQueryService.transformExcle(InvoiceEntityList);
