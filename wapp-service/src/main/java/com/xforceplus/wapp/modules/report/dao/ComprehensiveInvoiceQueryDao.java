 ...
 */
@Mapper
public interface ComprehensiveInvoiceQueryDao extends BaseDao<ComprehensiveInvoiceQueryEntity> {
     ...
     * @return
     */
    List<ComprehensiveInvoiceQueryEntity> queryListSL(@Param("schemaLabel") String schemaLabel, @Param("map") Map<String, Object> map);
