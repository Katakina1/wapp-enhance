...
public interface EinvoiceQueryService {
     ...
     * }}
     */
    R queryInvoiceMsg(String schemaLabel, EinvoiceQueryEntity queryEntity, Long userId);
     ...
     * @return 总条数 例如：100
     */
    ReportStatisticsEntity queryTotal(String schemaLabel, EinvoiceQueryEntity queryEntity);
