 ...
 ******************************************************************************
 */
public class InvoixeRefundExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "rebatenoForQueryXiaoList";
	/**
	 * 文件名后缀
	 */
	...
	public InvoixeRefundExportThread(IExcelExportService exportLogService,
                                     ExportLogEntity exportLog, RebatenoForQueryXiaoService rebatenoForQueryXiaoService,
                                     FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.rebatenoForQueryXiaoService = rebatenoForQueryXiaoService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =rebatenoForQueryXiaoService.invoiceMatchCount(map);
					...
					sheet.setClazz(RebatenoForQueryXiaoExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<RebatenoForQueryXiaoEntity> InvoiceEntityList = rebatenoForQueryXiaoService.queryList(query1);
						List<RebatenoForQueryXiaoExcelEntity> list2=rebatenoForQueryXiaoService.transformExcle(InvoiceEntityList);
