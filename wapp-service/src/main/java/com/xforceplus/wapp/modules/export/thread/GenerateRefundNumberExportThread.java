...
import com.xforceplus.wapp.modules.scanRefund.entity.*;
 ...
 ******************************************************************************
 */
public class GenerateRefundNumberExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "GenerateRefundNumber";
	/**
	 * 文件名后缀
	 */
	...
	public GenerateRefundNumberExportThread(IExcelExportService exportLogService,
                                            ExportLogEntity exportLog, GenerateRefundNumberService generateRefundNumberService,
                                            FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.generateRefundNumberService = generateRefundNumberService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					ReportStatisticsEntity totalRowCount1 =generateRefundNumberService.queryTotalResult(userName,map);
					Integer totalRowCount = totalRowCount1.getTotalCount();
					...
					sheet.setClazz(SctdhExcelEntity.class);
...
//						map.put("limit",500);
						...
						List<GenerateRefundNumberEntity> InvoiceEntityList = generateRefundNumberService.queryListAll(userName,map);
						List<SctdhExcelEntity> list2=generateRefundNumberService.transformExcle(InvoiceEntityList);
