 ...
 ******************************************************************************
 */
public class ScanHandleExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "扫描处理导出";
	/**
	 * 文件名后缀
	 */
	...
	public ScanHandleExportThread(IExcelExportService exportLogService,
								  ExportLogEntity exportLog, SignInInqueryService signInInqueryService,
	...
	public void run() {
		...
		try {
			...
			try {
				...
				Integer totalRowCount = signInInqueryService.queryTotal("", query);
				...
				sheet.setClazz(RecordInvoiceExcelEntity.class);
				...
				for (int i = 0; i < writeCount; i++) {
					...
					List<RecordInvoiceEntity> InvoiceEntityList = signInInqueryService.getRecordIncoiceList("", query1);
