...
public interface CostApplicationDao {
     ...
     * @return
     */
    int checkInvoices(@Param("invoiceDate") String invoiceDate,@Param("invoiceNo") String invoiceNo);
    /**
     * 获取购方信息
     * @return
     */
     ...
     * @return
     */
    Integer updateSettlementInvoice(@Param("costNo")String costNo, @Param("coverAmount") BigDecimal coverAmount, @Param("invoiceCode")String invoiceCode, @Param("invoiceNo")String invoiceNo,@Param("jvcode")String jvcode,@Param("venderid") String venderid);
    ...
    String getLoginname(Long loginname);
