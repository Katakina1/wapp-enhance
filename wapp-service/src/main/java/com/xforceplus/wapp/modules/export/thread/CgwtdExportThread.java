...
import com.xforceplus.wapp.modules.posuopei.entity.QuestionPaperExcelEntity;
 ...
 ******************************************************************************
 */
public class CgwtdExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "QuestionQuery";
	/**
	 * 文件名后缀
	 */
	...
	public CgwtdExportThread(IExcelExportService exportLogService,
                             ExportLogEntity exportLog, MatchService matchService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =matchService.questionPaperQuery(map).getTotalCount();
					...
					sheet.setClazz(QuestionPaperExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<QuestionPaperEntity> list1=matchService.questionPaperQuery(query1).getResults();
						List<QuestionPaperExcelEntity> list2=matchService.toExcel(list1);
