...
public interface IntelligentizeCheckDao {
     ...
     * 勾选操作
     */
    Integer intelligentizeCheck(@Param("schemaLabel") String schemaLabel, @Param("id")Long id,@Param("loginName")String loginName,@Param("userName")String userName,@Param("rzhBelongDate")String rzhBelongDate);
