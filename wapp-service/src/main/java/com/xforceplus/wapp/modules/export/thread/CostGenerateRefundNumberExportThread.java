 ...
 ******************************************************************************
 */
public class CostGenerateRefundNumberExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "costGenerateRefundNumber";
	/**
	 * 文件名后缀
	 */
	...
	public CostGenerateRefundNumberExportThread(IExcelExportService exportLogService,
                                                ExportLogEntity exportLog, CostGenerateRefundNumberService costgenerateRefundNumberService,
                                                FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.costgenerateRefundNumberService = costgenerateRefundNumberService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					ReportStatisticsEntity totalRowCount1 =costgenerateRefundNumberService.queryTotalResult(userName,map);
					...
					sheet.setClazz(GenerateRefundNumberExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<GenerateRefundNumberExcelEntity> list2 = costgenerateRefundNumberService.queryListAlls(userName,query1);
