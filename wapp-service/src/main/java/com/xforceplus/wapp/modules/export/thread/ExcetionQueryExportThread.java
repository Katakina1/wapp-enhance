 ...
 ******************************************************************************
 */
public class ExcetionQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "AbnormalInvoiceQuery";
	/**
	 * 文件名后缀
	 */
	...
	public ExcetionQueryExportThread(IExcelExportService exportLogService,
                                     ExportLogEntity exportLog, AbnormalInvoiceCollectionService abnormalInvoiceCollectionService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =abnormalInvoiceCollectionService.selectAbnormalInvoiceCollection(map).getTotalCount();
					...
					sheet.setClazz(CollectListStatisticExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<CollectListStatistic> list = abnormalInvoiceCollectionService.selectAbnormalInvoiceCollection(query1).getResults();
						List<CollectListStatisticExcelEntity> list2=abnormalInvoiceCollectionService.toExcel(list);
