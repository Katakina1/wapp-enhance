...
public interface SignatureProcessingService {
    ...
    Boolean deleteByuuid(String schemaLabel, String uuid,UserEntity user) throws Exception;
     ...
     Boolean deleteById(String schemaLabel, String id)throws Exception;
    Boolean returnById(String schemaLabel, String id)throws Exception;
    ...
    Boolean deleteMsgById(String schemaLabel, String id, String errMsg);

    Boolean scanDeleteIevoice(String schemaLabel, String id);
}
