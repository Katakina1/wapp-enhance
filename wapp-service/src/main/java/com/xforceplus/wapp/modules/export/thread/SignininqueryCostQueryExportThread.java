 ...
 ******************************************************************************
 */
public class SignininqueryCostQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "signininqueryCostQueryList";
	/**
	 * 文件名后缀
	 */
	...
	public SignininqueryCostQueryExportThread(IExcelExportService exportLogService,
                                              ExportLogEntity exportLog, SignininqueryCostQueryService signininqueryCostQueryService,
                                              FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.signininqueryCostQueryService = signininqueryCostQueryService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =signininqueryCostQueryService.queryCount(map);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<SettlementExcelEntity> list2 = signininqueryCostQueryService.queryAllList(query1);
