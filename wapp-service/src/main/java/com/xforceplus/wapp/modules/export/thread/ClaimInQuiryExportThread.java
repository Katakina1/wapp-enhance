 ...
 ******************************************************************************
 */
public class ClaimInQuiryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "claimInquiry";
	/**
	 * 文件名后缀
	 */
	...
	public ClaimInQuiryExportThread(IExcelExportService exportLogService,
                                    ExportLogEntity exportLog, ClaimInquiryService claimInquiryService,
                                    FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.claimInquiryService = claimInquiryService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =claimInquiryService.claimlistCount(map);
					...
					sheet.setClazz(ClaimExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<ClaimExcelEntity> list2 = claimInquiryService.selectExcelClaimlist(query1);
