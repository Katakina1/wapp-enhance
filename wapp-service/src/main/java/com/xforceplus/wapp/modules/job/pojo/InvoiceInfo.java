...
public class InvoiceInfo extends BasePojo{
	...
	public String getSalerAcount() {
		return salerAcount;
	}

	public void setSalerAcount(String salerAcount) {
		this.salerAcount = salerAcount;
	}
	...
	public List<InvoiceDetailInfo> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<InvoiceDetailInfo> detailList) {
	...
	public String toString() {
		return "InvoiceInfo [invoiceCode=" + invoiceCode + ", invoiceNo="
				...
				+ invoiceDate + ", buyerName=" + buyerName + ", buyerTaxNo="
				+ buyerTaxNo + ", buyerAddressPhone=" + buyerAddressPhone
				+ ", buyerAcount=" + buyerAcount + ", salerName=" + salerName
				+ ", salerTaxNo=" + salerTaxNo + ", salerAddressPhone="
				+ salerAddressPhone + ", salerAcount=" + salerAcount
				+ ", invoiceAmount=" + invoiceAmount + ", taxAmount="
				+ taxAmount + ", totalAmount=" + totalAmount + ", remark="
				+ remark + ", invoiceStatus=" + invoiceStatus
				+ ", legalizeState=" + legalizeState + ", legalizeDate="
				+ legalizeDate + ", legalizeBlongDate=" + legalizeBlongDate
				+ ", sfdbts=" + sfdbts + ", rzlx=" + rzlx + ", checkCode="
				+ checkCode + ", detailList=" + detailList + "]";
	}
