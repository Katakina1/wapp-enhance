 ...
 ******************************************************************************
 */
public class QuestionListExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "questionList";
	/**
	 * 文件名后缀
	 */
	...
	public QuestionListExportThread(IExcelExportService exportLogService,
                                    ExportLogEntity exportLog, ScanningService scanningService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =scanningService.scanningCount(map);
					...
					sheet.setClazz(ScanningExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<ScanningExcelEntity> list2 = scanningService.selectScanningList(query1);
