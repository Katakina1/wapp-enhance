 ...
 ******************************************************************************
 */
public class AuthenticationResultExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "AuthenticationResult";
	/**
	 * 文件名后缀
	 */
	...
	public AuthenticationResultExportThread(IExcelExportService exportLogService,
                                            ExportLogEntity exportLog, AuthenticationResultQueryService authenticationResultQueryService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =authenticationResultQueryService.getCertificationListCount(map).getTotalCount();
					...
					sheet.setClazz(InvoiceCollectionResultExcelInfo.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceCollectionResultExcelInfo> list2=authenticationResultQueryService.queryCertificationForExport(query1);
