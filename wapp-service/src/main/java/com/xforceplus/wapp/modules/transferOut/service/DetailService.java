...
public interface DetailService {
     ...
     * @return
     */
    List<DetailEntity> getInvoiceDetailList(String schemaLabel,Long  id);
     ...
     * @return
     */
    InvoiceEntity getInvoiceDetailList1(String schemaLabel,Long id)throws  Exception;
     ...
     * @return
     */
    List<DetailEntity> getCheckInvoiceDetail(String schemaLabel,Long  id);
     ...
     * @return
     */
    List<DetailEntity> getInvoiceDetailByUUID(String schemaLabel,String  uuid);
     ...
     * @return
     */
    DetailVehicleEntity getCheckVehicleDetail (String schemaLabel,Long id)throws  Exception;
