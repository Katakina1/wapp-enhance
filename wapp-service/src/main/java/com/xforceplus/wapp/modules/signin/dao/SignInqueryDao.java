...
public interface SignInqueryDao {
    ...
    Integer selectInvoiceCount(@Param("schemaLabel") String schemaLabel, @Param("uuid") String uuid,@Param("id") String id,@Param("invoiceDate") String invoiceDate ,@Param("invoiceAmount") String invoiceAmount);

    void updateGl(@Param("schemaLabel") String schemaLabel,@Param("query") Map<String, Object> params);
}
