 ...
 ******************************************************************************
 */
public class QueryCertificationExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "QueryCertification";
	/**
	 * 文件名后缀
	 */
	...
	public QueryCertificationExportThread(IExcelExportService exportLogService,
                                          ExportLogEntity exportLog, CertificationQueryService certificationQueryService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =certificationQueryService.getCertificationListCount(map).getTotalCount();
					...
					sheet.setClazz(InvoiceCollectionExcelInfo.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceCollectionExcelInfo> list2=certificationQueryService.queryCertificationExport(query1);
