 ...
 * 导入失败的债务数据导出
 */
public final class DebtFailureExcel extends AbstractExportExcel {
    ...
    public DebtFailureExcel(Map<String, List<DebtEntity>> map, String excelTempPath, String excelName) {
        this.map = map;
    ...
    protected void buildExcel(XSSFWorkbook workBook) {
        ...
        for (DebtEntity entity : mdList) {
            ...
            //失败原因
            setSheetValue(MDsheet, beginLine, 12,  entity.getFailureReason()==null?"":entity.getFailureReason(), style);
        ...
        for (DebtEntity entity : pcList) {
            ...
            //失败原因
            setSheetValue(PCsheet, beginLine, 15,  entity.getFailureReason()==null?"":entity.getFailureReason(), style);
            beginLine++;
        }
    }
