...
public class InvoiceCollectionExcelInfo extends BaseRowModel {


    @ExcelProperty(value={"序号"},index = 0)
    private String rownumber;
    @ExcelProperty(value={"认证状态"},index = 1)
    private String rzhYesorno;
    @ExcelProperty(value={"认证处理状态"},index = 2)
    ...
    @ExcelProperty(value={"供应商号"},index = 12)
    private String venderid;
    @ExcelProperty(value={"销方名称"},index = 13)
    private String xfName;
    @ExcelProperty(value={"金额"},index = 14)
    private String invoiceAmount;
    @ExcelProperty(value={"税额"},index = 15)
    private String taxAmount;
    @ExcelProperty(value={"发票状态"},index = 16)
    private String invoiceStatus;
    @ExcelProperty(value={"签收状态"},index = 17)
    private String qsStatus;
    @ExcelProperty(value={"签收日期"},index = 18)
    private String qsDate;
    @ExcelProperty(value={"JV"},index = 19)
    private String jvCode;
    @ExcelProperty(value={"公司代码"},index = 20)
