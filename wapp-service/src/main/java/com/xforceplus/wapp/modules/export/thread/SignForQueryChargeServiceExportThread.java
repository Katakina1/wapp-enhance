 ...
 ******************************************************************************
 */
public class SignForQueryChargeServiceExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "SignForQueryChargeList";
	/**
	 * 文件名后缀
	 */
	...
	public SignForQueryChargeServiceExportThread(IExcelExportService exportLogService,
                                                 ExportLogEntity exportLog, SignForQueryChargeService signForQueryChargeService,
                                                 FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.signForQueryChargeService = signForQueryChargeService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =signForQueryChargeService.invoiceMatchCount(map);
					...
					sheet.setClazz(SignForQueryExcel1Entity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<SignForQueryExcel1Entity> list2 = signForQueryChargeService.queryListAll(query1);
