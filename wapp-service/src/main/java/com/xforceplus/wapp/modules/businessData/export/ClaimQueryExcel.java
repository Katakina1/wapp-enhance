 ...
 * 索赔信息导出
 */
public final class ClaimQueryExcel extends AbstractExportExcel {

    private final PagedQueryResult<ClaimEntity> poEntityPagedQueryResult;
    ...
    public ClaimQueryExcel(PagedQueryResult<ClaimEntity> poEntityPagedQueryResult,Map<String,Object> map, String excelTempPath, String excelName) {
    ...
    protected void buildExcel(XSSFWorkbook workBook) {
        ...
        //获取要导出的数据
        final List<ClaimEntity> list = this.poEntityPagedQueryResult.getResults();
        //设置开始行
        int beginLine = 2;
        //获取单元格样式
        ...
        for (ClaimEntity entity : list) {
            ...
            //门店号
            setSheetValue(sheet, beginLine, 2, entity.getExchangeno(), style);
            //部门号
