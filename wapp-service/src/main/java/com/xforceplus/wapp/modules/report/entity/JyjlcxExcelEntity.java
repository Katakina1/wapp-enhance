...
@Getter
@Setter
public class JyjlcxExcelEntity extends BaseRowModel implements Serializable {




    @ExcelProperty(value={"借阅记录查询"},index = 0)
    private String cell0;

    @ExcelProperty(value={"借阅记录查询"},index = 1)
    private String cell1;

    @ExcelProperty(value={"借阅记录查询"},index = 2)
    private String cell2;

    @ExcelProperty(value={"借阅记录查询"},index = 3)
    private String cell3;

    @ExcelProperty(value={"借阅记录查询"},index = 4)
    private String cell4;

    @ExcelProperty(value={"借阅记录查询"},index = 5)
    private String cell5;

    @ExcelProperty(value={"借阅记录查询"},index = 6)
    ...
    @ExcelProperty(value={"借阅记录查询"},index = 7)
    private String cell7;

    @ExcelProperty(value={"借阅记录查询"},index = 8)
    private String cell8;



    @ExcelProperty(value={"借阅记录查询"},index = 9)
    private String cell9;

    @ExcelProperty(value={"借阅记录查询"},index = 10)
    private String cell10;

    @ExcelProperty(value={"借阅记录查询"},index = 11)
    private String cell11;

    @ExcelProperty(value={"借阅记录查询"},index = 12)
    private String cell12;

    @ExcelProperty(value={"借阅记录查询"},index = 13)
    private String cell13;

    @ExcelProperty(value={"借阅记录查询"},index = 14)
