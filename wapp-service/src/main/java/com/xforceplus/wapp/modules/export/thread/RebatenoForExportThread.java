 ...
 ******************************************************************************
 */
public class RebatenoForExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "rebatenoFor";
	/**
	 * 文件名后缀
	 */
	...
	public RebatenoForExportThread(IExcelExportService exportLogService,
                                   ExportLogEntity exportLog, RebatenoForQueryService rebatenoForQueryService,
                                   FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.rebatenoForQueryService = rebatenoForQueryService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =rebatenoForQueryService.invoiceMatchCount(map);
					...
					sheet.setClazz(RebatenoForQueryExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<RebatenoForQueryExcelEntity> list2 = rebatenoForQueryService.queryListAll(query1);
