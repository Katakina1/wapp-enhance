 ...
 ******************************************************************************
 */
public class InvoiceCollectionExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "InvoiceCollection";
	/**
	 * 文件名后缀
	 */
	...
	public InvoiceCollectionExportThread(IExcelExportService exportLogService,
                                         ExportLogEntity exportLog, InvoiceCollectionService invoiceCollectionService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =invoiceCollectionService.selectInvoiceCollection(map).getTotalCount();
					...
					sheet.setClazz(CollectListExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<CollectListStatistic> list = invoiceCollectionService.selectInvoiceCollection(query1).getResults();
						List<CollectListExcelEntity> list2=invoiceCollectionService.toExcel(list);
