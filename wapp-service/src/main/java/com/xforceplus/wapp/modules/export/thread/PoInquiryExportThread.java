 ...
 ******************************************************************************
 */
public class PoInquiryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "poInquiry";
	/**
	 * 文件名后缀
	 */
	...
	public PoInquiryExportThread(IExcelExportService exportLogService,
                                 ExportLogEntity exportLog, PoInquiryService poInquiryService,
                                 FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.poInquiryService = poInquiryService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =poInquiryService.polistCount(map);
					...
					sheet.setClazz(poExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<poExcelEntity> list2 = poInquiryService.selectExcelpolist(query1);
