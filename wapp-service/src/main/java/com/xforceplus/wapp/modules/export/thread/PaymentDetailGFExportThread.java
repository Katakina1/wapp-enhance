 ...
 ******************************************************************************
 */
public class PaymentDetailGFExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "paymentDetail";
	/**
	 * 文件名后缀
	 */
	...
	public PaymentDetailGFExportThread(IExcelExportService exportLogService,
                                       ExportLogEntity exportLog, PaymentDetailService paymentDetailService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =paymentDetailService.paylistCount(map);
					...
					sheet.setClazz(PaymentDetailExcelEntity1.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<PaymentDetailExcelEntity1> list2 = paymentDetailService.selectFindPayListGF(query1);
