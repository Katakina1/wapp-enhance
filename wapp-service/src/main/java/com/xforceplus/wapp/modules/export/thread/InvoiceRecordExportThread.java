 ...
 ******************************************************************************
 */
public class InvoiceRecordExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "InvoiceRecord";
	/**
	 * 文件名后缀
	 */
	...
	public InvoiceRecordExportThread(IExcelExportService exportLogService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =invoiceBorrowService.queryBorrowRecordList(map).getTotalCount();
					...
					sheet.setClazz(JyjlcxExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<JyjlcxExcelEntity> list2=invoiceBorrowService.transformExcle3(invoiceBorrowService.queryBorrowRecordList(query1).getResults());
