 ...
 ******************************************************************************
 */
public class MatchingQueryGFExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "pipeichaxunList";
	/**
	 * 文件名后缀
	 */
	...
	public MatchingQueryGFExportThread(IExcelExportService exportLogService,
                                       ExportLogEntity exportLog, DetailsService detailsService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =detailsService.getMatchCount(map);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<MatchEntity> InvoiceEntityList = detailsService.getMatchList(query1).getResults();
						List<MatchExcelEntity> list2=detailsService.transformExcle(InvoiceEntityList);
