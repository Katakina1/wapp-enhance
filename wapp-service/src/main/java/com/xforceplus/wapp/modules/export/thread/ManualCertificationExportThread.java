 ...
 ******************************************************************************
 */
public class ManualCertificationExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "ManualCertification";
	/**
	 * 文件名后缀
	 */
	...
	public ManualCertificationExportThread(IExcelExportService exportLogService,
                                           ExportLogEntity exportLog, ManualCertificationService manualCertificationService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =manualCertificationService.queryTotal(null,map).getTotalCount();
					...
					sheet.setClazz(InvoiceCertificationExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceCertificationExcelEntity> list2=manualCertificationService.queryExportList(null,query1);
