 ...
 ******************************************************************************
 */
public class SupplierInformationQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "SupplierInformationQuery";
	/**
	 * 文件名后缀
	 */
	...
	public SupplierInformationQueryExportThread(IExcelExportService exportLogService,
                                                ExportLogEntity exportLog, SupplierInformationSearchService supplierInformationSearchService,
                                                FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.supplierInformationSearchService = supplierInformationSearchService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =supplierInformationSearchService.queryResult(map).getTotalCount();
					...
					sheet.setClazz(SupplierInformationSearchExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<SupplierInformationSearchEntity> list = supplierInformationSearchService.queryResult(query1).getResults();
						List<SupplierInformationSearchExcelEntity> list2=supplierInformationSearchService.transformExcle(list);
