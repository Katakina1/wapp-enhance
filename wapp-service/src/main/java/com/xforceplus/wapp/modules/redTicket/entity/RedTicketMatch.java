...
public class RedTicketMatch  extends AbstractBaseDomain {
    ...
    private String scanMatchStatus;//扫描匹配状态
    private String venderName;//供应商名称
    private String taxNo;//供应商税号
    private Date examineDate;//审核时间
    private Date uploadRednoticeTime;//上传红字通知单时间
    private Date openRedticketTime;//录入红票时间
    private Date twoExamineTime;//上次审核不同意时间
    private String twoAuditRemarks;//上次审核备注
    ...
    public Date getTwoExamineTime() {
        return twoExamineTime;
    }

    public void setTwoExamineTime(Date twoExamineTime) {
        this.twoExamineTime = twoExamineTime;
    }

    public String getTwoAuditRemarks() {
        return twoAuditRemarks;
    }

    public void setTwoAuditRemarks(String twoAuditRemarks) {
        this.twoAuditRemarks = twoAuditRemarks;
    }

    public Date getUploadRednoticeTime() {
        return uploadRednoticeTime;
    }

    public void setUploadRednoticeTime(Date uploadRednoticeTime) {
        this.uploadRednoticeTime = uploadRednoticeTime;
    }

    public Date getOpenRedticketTime() {
        return openRedticketTime;
    }

    public void setOpenRedticketTime(Date openRedticketTime) {
        this.openRedticketTime = openRedticketTime;
    }
