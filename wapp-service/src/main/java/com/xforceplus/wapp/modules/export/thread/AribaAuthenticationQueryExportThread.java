 ...
 ******************************************************************************
 */
public class AribaAuthenticationQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "AribaAuthenticationQuery";
	/**
	 * 文件名后缀
	 */
	 ...
	 * excel的标题
	 */
	private String title = "Ariba税务传票清单";
	...
	public AribaAuthenticationQueryExportThread(IExcelExportService exportLogService,
                                                ExportLogEntity exportLog, AuthenticationQueryService authenticationQueryService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =authenticationQueryService.getAribaCertificationListCount(map).getTotalCount();
					...
					sheet.setClazz(InvoiceCollectionTaxExcelInfo.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<InvoiceCollectionTaxExcelInfo> list = authenticationQueryService.queryAribaCertificationForExcel(query1);
