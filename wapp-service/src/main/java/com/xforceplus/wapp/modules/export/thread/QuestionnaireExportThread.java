 ...
 ******************************************************************************
 */
public class QuestionnaireExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "questionnaireList";
	/**
	 * 文件名后缀
	 */
	 ...
	 * excel的标题
	 */
	private String title = "HOST匹配失败报告";
	...
	public QuestionnaireExportThread(IExcelExportService exportLogService,
                                     ExportLogEntity exportLog, QuestionnaireService questionnaireService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =questionnaireService.questionnairelistCount(map);
					...
					sheet.setClazz(QuestionnaireExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<QuestionnaireEntity> InvoiceEntityList = questionnaireService.questionnairelist(query1);
						List<QuestionnaireExcelEntity> list2=questionnaireService.transformExcle(InvoiceEntityList);
