 ...
 ******************************************************************************
 */
public class UploadScarletterQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "uploadScarletterList";
	/**
	 * 文件名后缀
	 */
	...
	public UploadScarletterQueryExportThread(IExcelExportService exportLogService,
			...
			try {
				...
				try {
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<UploadScarletLetterEntity> list = uploadScarletLetterService.queryListAll(query1);
						List<UploadScarleQueryExcelEntity> list2=uploadScarletLetterService.toExcel(list);
