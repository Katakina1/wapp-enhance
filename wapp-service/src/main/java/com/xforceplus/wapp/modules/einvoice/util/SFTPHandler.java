...
//        }
     ...
     */
    public String onlyUploadImg(String gfTaxNo, String pathDate, byte[] zipByte,String uploadFile) throws SftpException, FileNotFoundException {
        String path = null;
        try {
        ...
        InputStream in = new ByteArrayInputStream(zipByte);
