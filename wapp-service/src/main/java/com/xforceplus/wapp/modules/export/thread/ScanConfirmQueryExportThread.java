 ...
 ******************************************************************************
 */
public class ScanConfirmQueryExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "ScanConfirmQuery";
	/**
	 * 文件名后缀
	 */
	...
	public ScanConfirmQueryExportThread(IExcelExportService exportLogService,
                                        ExportLogEntity exportLog, ScanConfirmService scanConfirmService,
	...
	public void run() {
			...
			try {
				...
				try {
					...
					sheet.setClazz(SpthpExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<ComprehensiveInvoiceQueryEntity> list = scanConfirmService.queryList(query1);
