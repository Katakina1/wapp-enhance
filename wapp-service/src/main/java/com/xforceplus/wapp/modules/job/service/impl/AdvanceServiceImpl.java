...
//                //step.3 启动流程
//                args.put("boName", "BO_ACT_EPS_VENDOR_MAIN");
//                String sql="SELECT V.* FROM BO_ACT_EPS_VENDOR_MAIN V LEFT JOIN WFC_TASK T ON V.BINDID=T.PROCESSINSTID WHERE ACTIVITYDEFID='obj_c83c6f3e51f00001cbc116001b106fb0' AND (V.COSTNO IS NULL  OR V.COSTNO = '') AND V.BINDID="+epsNos;
