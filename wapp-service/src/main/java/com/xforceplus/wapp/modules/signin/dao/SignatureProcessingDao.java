...
public interface SignatureProcessingDao {
    ...
    Boolean deleteInviceById(@Param("schemaLabel")String schemaLabel,@Param("id") String id);
    Boolean returnInviceById(@Param("schemaLabel")String schemaLabel,@Param("id") String id);

    Boolean deleteMsgById(@Param("schemaLabel")String schemaLabel,@Param("id") String id,@Param("errMsg")  String errMsg);

    Boolean scanDeleteIevoice(@Param("schemaLabel")String schemaLabel,@Param("id") String id);
}
