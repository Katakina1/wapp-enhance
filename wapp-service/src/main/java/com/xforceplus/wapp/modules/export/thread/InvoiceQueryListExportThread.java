 ...
 ******************************************************************************
 */
public class InvoiceQueryListExportThread extends BaseThread {
	 ...
	 * 文件名前缀
	 */
	private String fileNamePrefix = "invoiceQueryList";
	/**
	 * 文件名后缀
	 */
	...
	public InvoiceQueryListExportThread(IExcelExportService exportLogService,
                                        ExportLogEntity exportLog, ComprehensiveInvoiceQueryService comprehensiveInvoiceQueryService,
                                        FtpUtilService ftpService) {
		
		this.exportLogService = exportLogService;
		this.exportLog = exportLog;
		this.comprehensiveInvoiceQueryService = comprehensiveInvoiceQueryService;
	...
	public void run() {
			...
			try {
				...
				try {
					...
					Integer totalRowCount =comprehensiveInvoiceQueryService.queryTotalResult("",map).getTotalCount();
					...
					sheet.setClazz(ComprehensiveInvoiceQueryExcelEntity.class);
					...
					for (int i = 0; i < writeCount; i++) {
						...
						List<ComprehensiveInvoiceQueryExcelEntity> list2 = comprehensiveInvoiceQueryService.queryExcelListAll(null,query1);
