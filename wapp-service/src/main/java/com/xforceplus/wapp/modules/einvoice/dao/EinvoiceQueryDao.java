 ...
 */
@Mapper
public interface EinvoiceQueryDao extends BaseDao<EinvoiceQueryEntity> {
     ...
     * @return 总条数
     */
    ReportStatisticsEntity queryInvoiceListCount(@Param("schemaLabel") String schemaLabel, @Param("query") EinvoiceQueryEntity query);
