package com.xforceplus.wapp.utils.excel;
...
import com.xforceplus.wapp.common.utils.StyleExcelHandler;
...
public class ExcelUtil {
    ...
    public static <T extends BaseRowModel> void writeExcel(HttpServletResponse response, List<T> list,
        ...
        if(excelTypeEnum == ExcelTypeEnum.XLSX) {
            ...
            ExcelWriter writer =new ExcelWriter(null,getOutputStream(fileName, response, excelTypeEnum), ExcelTypeEnum.XLSX,true,handler);
//                    EasyExcelFactory.getWriterWithTempAndHandler(null,
