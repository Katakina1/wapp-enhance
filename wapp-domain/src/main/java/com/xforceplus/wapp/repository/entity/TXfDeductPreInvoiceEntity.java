...
@TableName(value="t_xf_deduct_pre_invoice")
public class TXfDeductPreInvoiceEntity extends BaseEntity {
    ...
    /**
     * 红字信息/预制发票占用业务单据的含税金额
     */
    @TableField("amount_with_tax")
    private BigDecimal amountWithTax;

    /**
     * 红字信息/预制发票占用业务单的税额（以红字信息（预制发票）税率为准）
     */
    @TableField("tax_amount")
    private BigDecimal taxAmount;

    /**
     * 红字信息/预制发票与业务单的税差（业务单税额-红字信息（预制发票）税额）
     */
    @TableField("tax_diff")
    ...
    public static final String AMOUNT_FLAG = "amount_flag";
