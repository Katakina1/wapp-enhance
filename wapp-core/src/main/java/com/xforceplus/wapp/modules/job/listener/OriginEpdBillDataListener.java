 ...
 **/
@Slf4j
public class OriginEpdBillDataListener extends AnalysisEventListener<List<OriginEpdBillDto>> {
    /**
    ...
    @Override
    public void invoke(List<OriginEpdBillDto> data, AnalysisContext context) {
        list.addAll(data);
