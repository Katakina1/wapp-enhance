...
public class RecordInvoiceResponse {
    ...
    @ApiModelProperty("换票审核状态")
    private String auditStatus;

    @ApiModelProperty("换票审核提交原因")
    private String auditSubmitRemark;

    @ApiModelProperty("换票审核提交时间")
    private Date auditSubmitTime;

    @ApiModelProperty("换票审核审批备注")
    private String auditRemark;

    @ApiModelProperty("换票审核时间")
    private Date auditTime;

    @ApiModelProperty("发票显示状态 0-正常红票;1-正常蓝票;2-蓝冲待审核;3-红票待蓝冲;4-蓝票待审核;5-红票已蓝冲")
    private String invoiceShowStatus;
