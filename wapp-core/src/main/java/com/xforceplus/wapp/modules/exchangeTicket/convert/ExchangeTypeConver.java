...
import com.xforceplus.wapp.enums.ExchangeTypeEnum;

public class ExchangeTypeConver implements Converter<String> {
    @Override
    ...
    public CellData convertToExcelData(String o, ExcelContentProperty excelContentProperty, GlobalConfiguration globalConfiguration) throws Exception {
        ...
        return new CellData(ExchangeTypeEnum.getValue(o));
