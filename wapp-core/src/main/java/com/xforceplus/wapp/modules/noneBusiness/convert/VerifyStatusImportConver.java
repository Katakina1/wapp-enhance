...
import com.xforceplus.wapp.enums.VerifyStatusExportEnum;
import org.apache.commons.lang.StringUtils;

public class VerifyStatusImportConver implements Converter<String> {
    @Override
    ...
    public String convertToJavaData(CellData cellData, ExcelContentProperty excelContentProperty, GlobalConfiguration globalConfiguration) throws Exception {
        ...
        if(StringUtils.isNotEmpty(str)){
            return VerifyStatusExportEnum.getCode(str);
        }
        return null;
    }
    ...
    public CellData convertToExcelData(String o, ExcelContentProperty excelContentProperty, GlobalConfiguration globalConfiguration) throws Exception {
        ...
        return new CellData(VerifyStatusExportEnum.getValue(o));
