package com.xforceplus.wapp.sequence;
...
public class IDSequence {
    ...
    /**
     * 起始时间戳
     * 老的，先放着 1519740777809L;
     **/
    public final static long START_TIME = 1634189909000L;
    ...
    public IDSequence(long dataCenterId) {
        this(dataCenterId, 0x000000FF & getLastIPAddress(), false, 5L, false);
    }

    public IDSequence(long dataCenterId,boolean randomSequence) {
        this(dataCenterId, 0x000000FF & getLastIPAddress(), false, 5L, randomSequence);
    }

    public IDSequence(long dataCenterId, boolean clock, boolean randomSequence) {
     ...
     */
    public IDSequence(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
    ...
    public static byte getLastIPAddress() {
                ...
                for (Enumeration inetAddrs = iface.getInetAddresses(); inetAddrs.hasMoreElements(); ) {
                    ...
                    if (!inetAddr.isLoopbackAddress()) {// 排除loopback类型地址
                        if (inetAddr.isSiteLocalAddress()) {
                            ...
                            byte[] addressByte = inetAddr.getAddress();
        ...
        log.info("当前获取的IP号:{}", LAST_IP);
        return LAST_IP;
    }


//    public static void main(String[] args) {
//        IDSequence idSequence = new IDSequence(0L);
