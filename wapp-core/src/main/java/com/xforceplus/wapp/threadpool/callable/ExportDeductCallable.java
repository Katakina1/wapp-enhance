...
//import com.xforceplus.wapp.modules.deduct.service.BillExportService;
...
//
//
//    public ExportDeductCallable(BillExportService billExportService, DeductBillExportDto dto) {
...
//            isSuccess = billExportService.doExport(dto);
//        } catch (Exception e) {
//            logger.error("导出失败", e);
//            isSuccess = false;
//        }
